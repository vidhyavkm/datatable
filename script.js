...
async function postData() {
    try {
        ...
        if (flag == "create") {
            var postinfo = await fetch("https://5cdd0a92b22718001417c19d.mockapi.io/api/users", {
                method: "POST",
                headers: {
        ...
        if(flag == "edit"){
            var postinfo = await fetch("https://5cdd0a92b22718001417c19d.mockapi.io/api/users/" + selectedId, {
                method: "PUT",
                headers: {
                    "Content-type": "application/json"
                },
...
async function getData() {
    var data = await fetch("https://5cdd0a92b22718001417c19d.mockapi.io/api/users");
...
async function deleteData(id) {
    var deleteData = await fetch("https://5cdd0a92b22718001417c19d.mockapi.io/api/users/" + id, {
        method: "DELETE"
    })
...
async function editData(id) {
    ...
    var rowData = await fetch("https://5cdd0a92b22718001417c19d.mockapi.io/api/users/" + id);
